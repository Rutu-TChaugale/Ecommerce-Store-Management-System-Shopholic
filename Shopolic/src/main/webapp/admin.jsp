...
<%@page import="com.sit.model.Category"%> <%@page
	import="java.util.List"%> <%@page
	import="com.sit.util.FactoryProvider"%> <%@page
	import="com.sit.dao.CategoryDao"%> <%@page
	import="com.sit.model.User"%> <%@page
	import="com.sit.dao.ProductDao"%> <%@page
	import="com.sit.util.FactoryProvider"%> <%@ page
	import="com.sit.dao.UserDao"%> <%@ page
	import="com.sit.util.FactoryProvider"%> <%@ page
 ...
 int productCount = pdao.getProductCount();
 %> <%
					...
					<div class="card-body text-center">
						<div class="container">
							<img style="max-width: 125px;" class="img-fluid rounded-circle"
								src="img/usericon.png" alt="user_icon">
						</div>
						<h1><%=userCount%></h1>
			...
			<div class="col-md-6">
				...
				<div class="card" data-toggle="modal"
					...
					<div class="card-body text-center">
						...
						<div class="container">
							<img style="max-width: 125px;" class="img-fluid rounded-circle"
								src="img/Add Category.png" alt="user_icon">
			...
			<div class="col-md-6">
				...
				<div class="card" data-toggle="modal"
					...
					<div class="card-body text-center">
						...
						<div class="container">
							<img style="max-width: 125px;" class="img-fluid rounded-circle"
								src="img/Add Product.png" alt="user_icon">
