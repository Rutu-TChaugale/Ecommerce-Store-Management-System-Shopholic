...
<body>
							...
							<!-- <div class="card product-card">
								...
								<div class="card-footer text-center">
									<button class="btn custom-bg text-white"
										onclick="add_to_cart(9999, 'Earbuds', 999)">Add to
										Cart</button>
							...
							<!-- <div class="card product-card">
								...
								<div class="card-body">
									...
									<p class="card-text">Embrace elegance with our stylish
										women’s kurti, made from high-quality, breathable fabric.degisn is good look is good all good
								</div>
								<div class="card-footer text-center">
									<button class="btn custom-bg text-white"
										onclick="add_to_cart(9998, 'Women Kurti', 1499)">Add
										to Cart</button>
									<button class="btn btn-outline-success">
 ...
 -->
							<!-- <div class="card product-card">
								...
								<div class="card-footer text-center">
									<button class="btn custom-bg text-white"
										onclick="add_to_cart(9997, 'Laptop', 24999)">Add to
										Cart</button>
									<button class="btn btn-outline-success">
							...
							<!-- <div class="card product-card">
								...
								<div class="card-body">
									...
									<p class="card-text">tay ahead with this stylish smartwatch
										featuring heart rate  Water-resistant design with a long-lasting
										battery.</p>
								</div>
								<div class="card-footer text-center">
									<button class="btn custom-bg text-white"
										onclick="add_to_cart(2500.0, 'Premium Smartwatch with Health Tracker', 2000.0)">Add to
										Cart</button>
									<button class="btn btn-outline-success">
							...
							<!-- <div class="card product-card">
								...
								<div class="card-footer text-center">
									<button class="btn custom-bg text-white"
										onclick="add_to_cart(40000.0, '55-inch 4K Smart TV', 36000.0)">Add to
										Cart</button>
									<button class="btn btn-outline-success">
							...
							<div class="card product-card">
								...
								<div class="card-footer text-center">
									<button class="btn custom-bg text-white"
										onclick="add_to_cart(1299, 'Men's Running Shoes', 1080)">Add to
										Cart</button>
										<button class="btn btn-outline-success">
							...
							<%-- <div class="card product-card">
								...
								<div class="card-footer text-center">
									...
									<button class="btn custom-bg text-white"
										onclick="add_to_wishlist(<%=p.getpId()%>, '<%=p.getpName()%>', <%=p.getpPrice()%>)">
							...
							<div class="card product-card" style="cursor: pointer;">
								<div class="container text-center" onclick="window.location.href='product_details.jsp?pid=<%=p.getpId()%>'">
									<img src="img/products/<%=p.getpPhoto()%>"
										style="max-height: 200px; max-width: 100%; width: auto;"
										class="card-img-top m-2" alt="Product Image">
								</div>
								...
								<div class="card-footer text-center">
									...
									<button class="btn custom-bg text-white" onclick="add_to_wishlist(<%=p.getpId()%>, '<%=p.getpName()%>', <%=p.getpPrice()%>)">
										<i class="fa fa-heart"></i>
									</button>
								</div>
							</div>
